...
export default function CTASection() {
  ...
  return (
    <section ref={ref} className="py-28 bg-[#0b0b0c] relative overflow-hidden border-t border-orange-500/15 content-auto">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        {/* Heading */}
        <h2 className={`text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6 ob-fade-up ${vis}`}>
          ¿Listo para recuperar tu
          <span className="text-orange-500"> cartera vencida</span>?
        </h2>

        {/* Subtitle */}
        <p className={`text-neutral-300 text-lg max-w-2xl mx-auto mb-10 leading-relaxed ob-fade-up ob-delay-1 ${vis}`}>
        ...
        {/* Primary CTA */}
        <div className={`flex justify-center mb-10 ob-fade-up ob-delay-2 ${vis}`}>
          <Link
            to="/contacto"
        ...
        {/* Contact pills */}
        <div className={`flex flex-col sm:flex-row gap-4 justify-center mb-14 ob-fade-up ob-delay-3 ${vis}`}>
          <a
